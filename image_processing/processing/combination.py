...
def find_difference(image1, image2):
    ...
    normallized_difference_image = (difference_image-np.min(difference_image)) / (np.max(difference_image) - np.min(difference_image))
    return normallized_difference_image
